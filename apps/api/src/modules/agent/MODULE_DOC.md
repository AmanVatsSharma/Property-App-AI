...
- 2026-03-21: **GraphQL JSON:** `messages` and other JSON fields use `GraphQLJSON` only; removed redundant `JsonScalar` Nest providers to avoid duplicate `JSON` scalar in schema.
